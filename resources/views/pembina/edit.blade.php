    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6 form-card">
                <h3 class="form-title">Form Edit Data Pembina</h3>

                <form action="{{ route('pembina.update', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4 form-group">
                        ...
                        <select name="jenis_kelamin" class="w-full">
                            ...
                            <option value="Laki-laki" {{ old('jenis_kelamin', optional($user->pembina)->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                            <option value="Perempuan" {{ old('jenis_kelamin', optional($user->pembina)->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                        @error('jenis_kelamin')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
