    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="card">
        <h3 class="header-title">
          <i class="fas fa-trophy me-2"></i>Tambah Prestasi Siswa
        </h3>
        ...
        <form action="{{ route('prestasi.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            @if(session('active_role') === 'siswa')
              ...
              <input type="text" class="form-control" value="{{ Auth::user()->siswa->nama }} ({{ Auth::user()->siswa->nis }})" readonly>
            @else
            ...
            <div class="form-col">
              <div class="form-group">
                ...
                <select name="jenis" id="jenis" class="form-select @error('jenis') is-invalid @enderror" required>
                  ...
                  <option value="non-akademik" {{ old('jenis') == 'non-akademik' ? 'selected' : '' }}>
                    Non-Akademik
                  </option>
                </select>
                @error('jenis')
          ...
          <div class="form-group">
            ...
            <textarea name="keterangan" 
                      ...
                      placeholder="Keterangan tambahan tentang prestasi (opsional)">{{ old('keterangan') }}</textarea>
            @error('keterangan')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
